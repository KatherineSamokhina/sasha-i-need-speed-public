...
function drawM5(g) {
  ...
  for (const side of [-1, 1]) {
    // тёмный корпус уголком
    roundRect(g, side * 60 - 26, -66, 52, 8, 3, "#2a0d0d");
    roundRect(g, side * 78 - 4, -66, 8, 22, 3, "#2a0d0d");
    // красное свечение тем же уголком
    roundRect(g, side * 60 - 23, -64, 47, 4, 2, "#e82121");
    roundRect(g, side * 78 - 2, -64, 4, 18, 2, "#e82121");
  }
  bnwBadge(g, 0, -56, 8);
  g.fillStyle = "#c9d0d7"; g.font = "italic bold 7px Verdana"; g.textAlign = "center";
  g.fillText("M5", -62, -38);
