...
function drawM5(g) {
  ...
  // Фонари — цельная буква L (правка Саши): вертикаль на углу
  // кузова плавно переходит в горизонтальную полосу к центру
  for (const side of [-1, 1]) {
    // тёмный корпус буквой L
    roundRect(g, side * 58 - 24, -60, 48, 8, 3, "#2a0d0d");
    roundRect(g, side * 78 - 4, -64, 8, 18, 3, "#2a0d0d");
    g.fillStyle = "#2a0d0d";
    g.fillRect(side * 70 - 4, -60, 12, 8);   // шов уголка — без зазора
    // красное свечение той же буквой
    roundRect(g, side * 58 - 21, -58, 44, 4, 2, "#e82121");
    roundRect(g, side * 78 - 2, -62, 4, 14, 2, "#e82121");
  }
  bnwBadge(g, 0, -56, 8);
  g.fillStyle = "#c9d0d7"; g.font = "italic bold 7px Verdana"; g.textAlign = "center";
  g.fillText("M5", -62, -38);
